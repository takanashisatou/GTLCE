    ...
    private static class ResearchStationRecipeLogic extends RecipeLogic {
        ...
        public boolean checkMatchedRecipeAvailable(GTRecipe match) {
            ...
            if (modified != null) {
                ...
                if (modified.checkConditions(this).isSuccess() && this.matchRecipeNoOutput(modified, machine).isSuccess() && this.matchTickRecipeNoOutput(modified, machine).isSuccess()) {
