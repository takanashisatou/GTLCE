...
public class KJSTagPrefix extends TagPrefix {
    ...
    public static KJSTagPrefix oreTagPrefix(String name) {
        return new KJSTagPrefix(name).prefixTagPath("ores/%s/%s").defaultTagPath("ores/%s").prefixOnlyTagPath("ores_in_ground/%s").unformattedTagPath("ores").materialIconType(MaterialIconType.ore).unificationEnabled(true).generationCondition(hasOreProperty);
    }
