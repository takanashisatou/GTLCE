...
public class CompassNode {
    ...
    public static class CompassNodeProvider implements DataProvider {
        ...
        public CompassNodeProvider(PackOutput output, ExistingFileHelper existingHelper) {
            this.output = output;
     ...
     * @return {@code this}.
     */
    public CompassNode page(final ResourceLocation page) {
        this.page = page;
        return this;
    }
     ...
     * @return {@code this}.
     */
    public CompassNode size(final int size) {
        this.size = size;
        return this;
    }
     ...
     * @return {@code this}.
     */
    public CompassNode position(@Nullable final Position position) {
     ...
     * @return {@code this}.
     */
    public CompassNode icon(@Nullable final Supplier<IGuiTexture> icon) {
        this.icon = icon;
        return this;
    }
     ...
     * @return {@code this}.
     */
    public CompassNode lang(final String lang) {
        this.lang = lang;
        return this;
    }
