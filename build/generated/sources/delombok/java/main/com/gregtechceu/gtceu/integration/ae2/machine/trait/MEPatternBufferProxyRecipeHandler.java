...
public class MEPatternBufferProxyRecipeHandler<T> extends NotifiableRecipeHandlerTrait<T> {
    ...
    @Override
    public List<T> handleRecipeInner(IO io, GTRecipe recipe, List<T> left, @Nullable String slotName, boolean simulate) {
    ...
    public void setHandlers(final Collection<NotifiableRecipeHandlerTrait<T>> handlers) {
