...
public class LargeTurbineMachine extends WorkableElectricMultiblockMachine implements ITieredMachine {
    ...
    public long getOverclockVoltage() {
        ...
        if (rotorHolder != null && rotorHolder.hasRotor()) return (long) BASE_EU_OUTPUT * rotorHolder.getTotalPower() / 100;
        return 0;
    }
    ...
    public static GTRecipe recipeModifier(MetaMachine machine, @NotNull GTRecipe recipe, @NotNull OCParams params, @NotNull OCResult result) {
        if (!(machine instanceof LargeTurbineMachine turbineMachine)) return null;
