...
public class OverclockingLogic {
    ...
    public static final OverclockingLogic PERFECT_OVERCLOCK = new OverclockingLogic(PERFECT_DURATION_FACTOR, STD_VOLTAGE_FACTOR, false);
    public static final OverclockingLogic NON_PERFECT_OVERCLOCK = new OverclockingLogic(STD_DURATION_FACTOR, STD_VOLTAGE_FACTOR, false);
    public static final OverclockingLogic PERFECT_OVERCLOCK_SUBTICK = new OverclockingLogic(PERFECT_DURATION_FACTOR, STD_VOLTAGE_FACTOR, true);
    public static final OverclockingLogic NON_PERFECT_OVERCLOCK_SUBTICK = new OverclockingLogic(STD_DURATION_FACTOR, STD_VOLTAGE_FACTOR, true);
    ...
    public OverclockingLogic(double durationFactor, double voltageFactor, boolean subtick) {
        if (subtick) {
            this.logic = (ocParams, ocResult, maxVoltage) -> subTickParallelOC(ocParams, ocResult, maxVoltage, durationFactor, voltageFactor);
        } else {
            this.logic = (ocParams, ocResult, maxVoltage) -> standardOverclockingLogic(ocParams, ocResult, maxVoltage, durationFactor, voltageFactor);
        }
    }
    ...
    public static void heatingCoilOC(@NotNull OCParams params, @NotNull OCResult result, long maxVoltage, int providedTemp, int requiredTemp) {
        ...
        result.init((long) (eut / Math.pow(STD_VOLTAGE_FACTOR, parallelIterAmount)), (int) duration, (int) parallel, (long) eut, ocLevel);
    }
