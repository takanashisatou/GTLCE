...
public class FluidVoidingCover extends PumpCover {
    ...
    protected void update() {
        if (coverHolder.getOffsetTimer() % 5 != 0) return;
        doVoidFluids();
    ...
    void voidAny(IFluidTransfer fluidTransfer) {
        ...
        for (FluidStack fluidStack : fluidAmounts.keySet()) {
            if (!filterHandler.test(fluidStack)) continue;
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new ToggleButtonWidget(10, 20, 20, 20, GuiTextures.BUTTON_POWER, this::isEnabled, this::setEnabled));
