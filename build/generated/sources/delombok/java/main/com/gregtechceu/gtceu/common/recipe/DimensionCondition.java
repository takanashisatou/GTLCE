...
public class DimensionCondition extends RecipeCondition {
    ...
    public SlotWidget setupDimensionMarkers(int xOffset, int yOffset) {
        ...
        SlotWidget dimSlot = new SlotWidget(transfer, 0, xOffset, yOffset, false, false).setIngredientIO(IngredientIO.INPUT);
    ...
    public RecipeCondition deserialize(@NotNull JsonObject config) {
        ...
        dimension = new ResourceLocation(GsonHelper.getAsString(config, "dim", "dummy"));
        return this;
    }
