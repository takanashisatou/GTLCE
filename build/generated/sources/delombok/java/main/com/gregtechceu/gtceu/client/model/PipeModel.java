...
public class PipeModel {
    ...
    public SupplierMemoizer.MemoizedSupplier<ResourceLocation> sideTexture;
    public SupplierMemoizer.MemoizedSupplier<ResourceLocation> endTexture;
    @Nullable
    public SupplierMemoizer.MemoizedSupplier<@Nullable ResourceLocation> secondarySideTexture;
    @Nullable
    public SupplierMemoizer.MemoizedSupplier<@Nullable ResourceLocation> secondaryEndTexture;
    ...
    public PipeModel(float thickness, Supplier<ResourceLocation> sideTexture, Supplier<ResourceLocation> endTexture, @Nullable Supplier<@Nullable ResourceLocation> secondarySideTexture, @Nullable Supplier<@Nullable ResourceLocation> secondaryEndTexture) {
        ...
        this.secondarySideTexture = secondarySideTexture != null ? SupplierMemoizer.memoize(secondarySideTexture) : null;
