...
public class IntProviderIngredient extends Ingredient {
    ...
    public ItemStack @NotNull [] getItems() {
        if (itemStacks == null) itemStacks = Arrays.stream(inner.getItems()).map(i -> i.copyWithCount(getSampledCount(GTValues.RNG))).toArray(ItemStack[]::new);
        return itemStacks;
    }
    ...
    public void setSampledCount(final Integer sampledCount) {
