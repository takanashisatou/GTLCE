    ...
    default void attachTooltips(TooltipsPanel tooltipsPanel) {
        if (ConfigHolder.INSTANCE.machines.enableMaintenance) {
            tooltipsPanel.attachTooltips(new IFancyTooltip.Basic(() -> GuiTextures.MAINTENANCE_ICON, () -> {
                final var tooltips = new ArrayList<Component>();
                ...
                if ((getMaintenanceProblems() & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.wrench", "\n"));
                if (((getMaintenanceProblems() >> 1) & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.screwdriver", "\n"));
                if (((getMaintenanceProblems() >> 2) & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.soft_mallet", "\n"));
                if (((getMaintenanceProblems() >> 3) & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.hard_hammer", "\n"));
                if (((getMaintenanceProblems() >> 4) & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.wire_cutter", "\n"));
                if (((getMaintenanceProblems() >> 5) & 1) == 0) tooltips.add(Component.translatable("gtceu.multiblock.universal.problem.crowbar", "\n"));
                return tooltips;
