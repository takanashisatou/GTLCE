...
public interface GTRecipeSchema {
    ...
    class GTRecipeJS extends RecipeJS {
        ...
        public GTRecipeJS chancedOutput(ExtendedOutputItem stack, String fraction, int tierChanceBoost) {
            ...
            if (split.length > 2) {
                GTCEu.LOGGER.error("Fraction or number was not parsed correctly! Expected format is \"1/3\" or \"1000\". Actual: \"{}\".", fraction, new Throwable());
                return this;
            }
            int chance;
            int maxChance;
        ...
        public GTRecipeJS chancedOutput(TagPrefix prefix, Material material, int count, String fraction, int tierChanceBoost) {
            return chancedOutput(ExtendedOutputItem.of(ChemicalHelper.get(prefix, material, count)), fraction, tierChanceBoost);
        }
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS perTick(final boolean perTick) {
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS chance(final int chance) {
            this.chance = chance;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS maxChance(final int maxChance) {
            this.maxChance = maxChance;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS tierChanceBoost(final int tierChanceBoost) {
            this.tierChanceBoost = tierChanceBoost;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS isFuel(final boolean isFuel) {
            this.isFuel = isFuel;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public GTRecipeSchema.GTRecipeJS onSave(final Consumer<GTRecipeJS> onSave) {
            this.onSave = onSave;
            return this;
        }
    ...
    RecipeKey<Map<RecipeCapability<?>, ChanceLogic>> INPUT_CHANCE_LOGICS = GTRecipeComponents.CHANCE_LOGIC_MAP.key("inputChanceLogics").defaultOptional();
    RecipeKey<Map<RecipeCapability<?>, ChanceLogic>> OUTPUT_CHANCE_LOGICS = GTRecipeComponents.CHANCE_LOGIC_MAP.key("outputChanceLogics").defaultOptional();
    RecipeKey<Map<RecipeCapability<?>, ChanceLogic>> TICK_INPUT_CHANCE_LOGICS = GTRecipeComponents.CHANCE_LOGIC_MAP.key("tickInputChanceLogics").defaultOptional();
    RecipeKey<Map<RecipeCapability<?>, ChanceLogic>> TICK_OUTPUT_CHANCE_LOGICS = GTRecipeComponents.CHANCE_LOGIC_MAP.key("tickOutputChanceLogics").defaultOptional();
    RecipeSchema SCHEMA = new RecipeSchema(GTRecipeJS.class, GTRecipeJS::new, DURATION, DATA, CONDITIONS, ALL_INPUTS, ALL_TICK_INPUTS, ALL_OUTPUTS, ALL_TICK_OUTPUTS, INPUT_CHANCE_LOGICS, OUTPUT_CHANCE_LOGICS, TICK_INPUT_CHANCE_LOGICS, TICK_OUTPUT_CHANCE_LOGICS, IS_FUEL).constructor((recipe, schemaType, keys, from) -> recipe.id(from.getValue(recipe, ID)), ID).constructor(DURATION, CONDITIONS, ALL_INPUTS, ALL_OUTPUTS, ALL_TICK_INPUTS, ALL_TICK_OUTPUTS);
}
