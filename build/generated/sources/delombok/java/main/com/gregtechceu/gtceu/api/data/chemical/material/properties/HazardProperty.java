...
public class HazardProperty implements IMaterialProperty<HazardProperty> {
    ...
    public enum ProtectionType {
        MASK(Set.of("head"), ArmorItem.Type.HELMET), HANDS(Set.of("hands"), ArmorItem.Type.CHESTPLATE), FULL(Set.of(), ArmorItem.Type.BOOTS, ArmorItem.Type.HELMET, ArmorItem.Type.CHESTPLATE, ArmorItem.Type.LEGGINGS), NONE(Set.of());
        ...
        public boolean isProtected(LivingEntity livingEntity) {
            ...
            ICuriosItemHandler curiosInventory = CuriosApi.getCuriosInventory(livingEntity).resolve().orElse(null);
        ...
        public void damageEquipment(Player player, int amount) {
            ...
            if (player.level().getGameTime() % 100 == 0) {
                ...
                if (GTCEu.isCuriosLoaded()) {
                    ICuriosItemHandler curiosInventory = CuriosApi.getCuriosInventory(player).resolve().orElse(null);
                    if (curiosInventory != null) {
