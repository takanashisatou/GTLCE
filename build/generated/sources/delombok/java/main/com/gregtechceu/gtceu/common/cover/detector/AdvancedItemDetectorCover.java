...
public class AdvancedItemDetectorCover extends ItemDetectorCover implements IUICover {
    ...
    protected void update() {
        ...
        for (int i = 0; i < itemTransfer.getSlots(); i++) {
            if (filter.test(itemTransfer.getStackInSlot(i))) storedItems += itemTransfer.getStackInSlot(i).getCount();
        }
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new ToggleButtonWidget(9, 20, 20, 20, GuiTextures.INVERT_REDSTONE_BUTTON, this::isInverted, this::setInverted) {
            ...
            public void updateScreen() {
                super.updateScreen();
                setHoverTooltips(List.copyOf(LangHandler.getMultiLang("cover.advanced_item_detector.invert." + (isPressed ? "enabled" : "disabled"))));
            }
        });
        // Item Filter UI:
