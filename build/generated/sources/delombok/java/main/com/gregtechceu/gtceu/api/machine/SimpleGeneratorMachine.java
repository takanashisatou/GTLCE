...
public class SimpleGeneratorMachine extends WorkableTieredMachine implements IFancyUIMachine, IEnvironmentalHazardEmitter {
    ...
    public SimpleGeneratorMachine(IMachineBlockEntity holder, int tier, float hazardStrengthPerOperation, Int2LongFunction tankScalingFunction, Object... args) {
    ...
    public static GTRecipe recipeModifier(MetaMachine machine, @NotNull GTRecipe recipe, @NotNull OCParams params, @NotNull OCResult result) {
        if (machine instanceof SimpleGeneratorMachine generator) {
            ...
            if (EUt > 0) {
                ...
                result.init(-RecipeHelper.getOutputEUt(paraRecipe.getFirst()), paraRecipe.getFirst().duration, paraRecipe.getSecond(), params.getOcAmount());
