...
public class ToggleButtonWidget extends SwitchWidget {
    ...
    public ToggleButtonWidget setShouldUseBaseBackground() {
        if (texture != null) {
            setTexture(new GuiTextureGroup(GuiTextures.TOGGLE_BUTTON_BACK.getSubTexture(0, 0, 1, 0.5), texture), new GuiTextureGroup(GuiTextures.TOGGLE_BUTTON_BACK.getSubTexture(0, 0.5, 1, 0.5), texture));
        }
        return this;
    }
     ...
     * @return {@code this}.
     */
    public ToggleButtonWidget setTooltipText(final String tooltipText) {
