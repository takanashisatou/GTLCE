...
public abstract class TagFilter<T, S extends Filter<T, S>> implements Filter<T, S> {
    ...
    public WidgetGroup openConfigurator(int x, int y) {
        ...
        group.addWidget(new ImageWidget(0, 0, 20, 20, GuiTextures.INFO_ICON).setHoverTooltips(LangHandler.getMultiLang("cover.ore_dictionary_filter.info").toArray(new MutableComponent[0])));
