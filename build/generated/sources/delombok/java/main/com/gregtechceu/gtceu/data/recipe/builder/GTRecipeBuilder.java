...
public class GTRecipeBuilder {
    ...
    public GTRecipeBuilder inputItems(Object input) {
        if (input instanceof Item item) {
            ...
            GTCEu.LOGGER.error("gt recipe {} input item is not one of: Item, Supplier<Item>, ItemStack, Ingredient, UnificationEntry, TagKey<Item>, MachineDefinition", id);
            return this;
        }
    }
    ...
    public GTRecipeBuilder outputItems(Object input) {
        if (input instanceof Item item) {
            ...
            GTCEu.LOGGER.error("gt recipe {} output item is not one of: Item, Supplier<Item>, ItemStack, Ingredient, UnificationEntry, TagKey<Item>, MachineDefinition", id);
            return this;
        }
    }
    ...
    public GTRecipeBuilder inputFluids(FluidStack... inputs) {
        return input(FluidRecipeCapability.CAP, Arrays.stream(inputs).map(fluid -> FluidIngredient.of(TagUtil.createFluidTag(BuiltInRegistries.FLUID.getKey(fluid.getFluid()).getPath()), fluid.getAmount())).toArray(FluidIngredient[]::new));
    }
    ...
    public GTRecipe buildRawRecipe() {
        return new GTRecipe(recipeType, id.withPrefix(recipeType.registryName.getPath() + "/"), input, output, tickInput, tickOutput, inputChanceLogic, outputChanceLogic, tickInputChanceLogic, tickOutputChanceLogic, conditions, List.of(), data, duration, isFuel);
    }
     ...
     * @return {@code this}.
     */
    public GTRecipeBuilder slotName(final String slotName) {
     ...
     * @return {@code this}.
     */
    public GTRecipeBuilder uiName(final String uiName) {
        this.uiName = uiName;
        return this;
    }
     ...
     * @return {@code this}.
     */
    public GTRecipeBuilder isFuel(final boolean isFuel) {
        this.isFuel = isFuel;
        return this;
    }
     ...
     * @return {@code this}.
     */
    public GTRecipeBuilder onSave(final BiConsumer<GTRecipeBuilder, Consumer<FinishedRecipe>> onSave) {
        this.onSave = onSave;
        return this;
    }
