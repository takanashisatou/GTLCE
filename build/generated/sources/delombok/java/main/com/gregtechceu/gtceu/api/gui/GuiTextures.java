...
public class GuiTextures {
    ...
    public static final ResourceTexture TOOL_SWITCH_CONVERTER_NATIVE = new ResourceTexture("gtceu:textures/gui/overlay/tool_wire_block.png"); // switch to tool_switch_converter_native once that gets
    // made
    public static final ResourceTexture TOOL_SWITCH_CONVERTER_EU = new ResourceTexture("gtceu:textures/gui/overlay/tool_wire_connect.png"); // switch to tool_switch_converter_eu once that gets
    // made
    // BASE TEXTURES
    ...
    public static final ResourceBorderTexture SLOT_DARK = new ResourceBorderTexture("gtceu:textures/gui/base/slot_dark.png", 18, 18, 1, 1);
    ...
    public static final ResourceTexture BUTTON_AUTO_PULL = new ResourceTexture("gtceu:textures/gui/widget/button_me_auto_pull.png");
    ...
    public static final ResourceTexture PATTERN_OVERLAY = new ResourceTexture("gtceu:textures/gui/widget/pattern_overlay.png");
    public static final ResourceTexture REFUND_OVERLAY = new ResourceTexture("gtceu:textures/gui/widget/refund_overlay.png");
    // INDICATORS & ICONS
    ...
    static {
        final var offset = 1.0F / TIER.length;
    ...
    // Lamp item overlay
    public static final ResourceTexture LAMP_NO_BLOOM = new ResourceTexture("gtceu:textures/gui/item_overlay/lamp_no_bloom.png");
    public static final ResourceTexture LAMP_NO_LIGHT = new ResourceTexture("gtceu:textures/gui/item_overlay/lamp_no_light.png");
    // ME hatch/bus
