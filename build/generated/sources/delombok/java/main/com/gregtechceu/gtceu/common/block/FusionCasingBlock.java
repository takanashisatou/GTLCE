...
public class FusionCasingBlock extends ActiveBlock {
    ...
    public enum CasingType implements IFusionCasingType, StringRepresentable {
        SUPERCONDUCTING_COIL("superconducting_coil", 2), FUSION_COIL("fusion_coil", 2), FUSION_CASING("fusion_casing", 2), FUSION_CASING_MK2("fusion_casing_mk2", 3), FUSION_CASING_MK3("fusion_casing_mk3", 3);
