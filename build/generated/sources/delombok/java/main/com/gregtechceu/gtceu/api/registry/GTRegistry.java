...
public abstract class GTRegistry<K, V> implements Iterable<V> {
    ...
    private boolean checkActiveModContainerIsGregtech() {
        ...
        return container != null && (container.getModId().equals(this.registryName.getNamespace()) || container.getModId().equals(GTCEu.MOD_ID) || container.getModId().equals("minecraft")); // check for minecraft modid in case of datagen or a mishap
    }
