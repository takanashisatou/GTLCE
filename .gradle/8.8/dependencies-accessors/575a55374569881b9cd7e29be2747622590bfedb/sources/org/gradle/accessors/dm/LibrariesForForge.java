 ...
 */
@NonNullApi
public class LibrariesForForge extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForForge(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
